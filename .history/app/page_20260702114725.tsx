...
>
  ...
  {/* Название */}
  <h3 className="font-bold text-lg text-(--loom-white) truncate leading-tight mb-2">{quiz.title}</h3>

  {/* Описание (заполняет низ) */}
  <p className="flex-1 text-sm text-(--loom-white)/60 pb-2 mb-2">{quiz.description}</p>
</div>
                  );
                })
              )}
