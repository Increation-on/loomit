...
>
  ...
  {/* Название */}
  <h3 className="font-bold text-lg text-(--loom-white) truncate leading-tight mg-1">{quiz.title}</h3>

  {/* Описание (заполняет низ) */}
  <p className="flex-1 text-sm text-(--loom-white)/60">{quiz.description}</p>
</div>
                  );
                })
              )}
