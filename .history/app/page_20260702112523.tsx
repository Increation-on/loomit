                    ...
                    >
                      <div className="flex items-center gap-2 mb-1">
                        {quiz.category?.iconUrl ? (
                          <img src={quiz.category.iconUrl} alt="" className="w-6 h-6 rounded object-contain bg-(--loom-black)/40 p-0.5" />
                        ) : (
                          <div className="w-6 h-6 rounded bg-(--loom-black)/40 flex items-center justify-center text-(--loom-white) text-xs font-bold">
