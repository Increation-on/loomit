...
export default function HomePage() {
  ...
  className={`w-56 h-44 shrink-0 snap-start bg-(--loom-cyan)/20 p-4 rounded-xl cursor-pointer relative transition-all duration-300 try-it-card flex flex-col ${
  ...
  <div className="flex items-center justify-center mb-2">
    {quiz.category?.iconUrl ? (
      <img 
        ...
        alt="" 
        className="w-10 h-10 rounded-full bg-(--loom-white)/10 p-1.5 object-contain" 
      />
    ) : (
      <div className="w-10 h-10 rounded-full bg-(--loom-white)/10 flex items-center justify-center text-(--loom-cyan) font-bold">
