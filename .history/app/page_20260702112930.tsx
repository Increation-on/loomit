                    ...
                    >
                      <div className="flex items-center justify-center mb-1.5">
                        {quiz.category?.iconUrl ? (
                          <img src={quiz.category.iconUrl} alt="" className="w-7 h-5 rounded object-contain bg-(--loom-black)/40 p-0.5" />
                        ) : (
                          <div className="w-7 h-7 rounded bg-(--loom-black)/40 flex items-center justify-center text-(--loom-white) text-xs font-bold">
