  ...
  <div className="flex items-center justify-between mb-1.5">
    <div className="flex items-center gap-2">
      {quiz.category?.iconUrl ? (
        <img src={quiz.category.iconUrl} alt="" className="w-6 h-6 rounded object-contain" />
      ) : (
        <div className="w-6 h-6 rounded bg-(--loom-cyan)/20 flex items-center justify-center text-(--loom-cyan) text-xs font-bold">
