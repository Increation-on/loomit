          ...
          <div className="space-y-3">
            {categories.slice(0, 4).map((cat: any) => (
              ...
              >
                ...
                <div className="w-6 h-6 rounded-full bg-(--loom-yellow) flex items-center justify-center shadow-[0_0_10px_var(--loom-yellow)]">
                  <ArrowRight size={14} className="text-(--loom-black)" />
                </div>
              </div>
            ))}
          </div>
